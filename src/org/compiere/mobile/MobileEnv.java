...
public class MobileEnv
{
	...
	/**
	 *  Base Directory links <b>http://localhost:8080/mobile</b>
	 *  to the physical <i>%mobile_HOME%/tomcat/webroot/mobile</i> directory
	 */
	public static final String   	DIR_BASE    = "/mobile";      //  /mobile
	/** Image Sub-Directory under BASE          */
	private static final String     DIR_IMAGE   = "images";         //  /mobile/images
	/** Stylesheet Name                         */
	private static final String     STYLE_STD   = "/css/standard.css";   //  /mobile/standard.css
	/** Small Logo. */
	private static final String     LOGO        = "LogoSmall.gif";  //  /mobile/LogoSmall.gif
	/** Store Sub-Directory under BASE          */
	private static final String     DIR_STORE   = "store";          //  /mobile/store
	...
	public static void dump (HttpServletRequest request)
	{
		...
		while (e.hasMoreElements())
		{
			...
			first = false;
			String key = (String)e.nextElement();
			String value = MobileUtil.getParameter (request, key);
			log.finer("  - " + key + " = " + value);
		}
		first = true;
		/** Attributes	*/
